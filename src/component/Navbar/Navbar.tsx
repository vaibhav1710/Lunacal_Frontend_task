...
<div className='w-full h-full'>
 ...
 <div className='h-[30%] m-1 p-2'>
  ...
  {/* Navbar Sections */}
  <div className={`About cursor-pointer rounded-2xl flex h-5/6 flex-1 items-center justify-center m-1 z-10
       ${activeSection === "About Me" ? "text-white" : "text-gray-300"} `}
       onClick={() => handleClick("About Me")}>
    About Me
  </div>

  <div className={`Experience cursor-pointer rounded-2xl h-5/6 flex-1 flex items-center justify-center m-1 z-10
      ${activeSection === "Experience" ? "text-white" : "text-gray-300"}`}
      onClick={() => handleClick("Experience")}>
    Experience
  </div>

  <div className={`Recommended cursor-pointer rounded-2xl h-5/6 flex-1 flex items-center justify-center m-1 z-10
